...
## 기간 / 인원 / 역할
- **기간**: 2025-1학기 IoT 프로젝트 (※ 정확한 기간은 필요시 수정)
- **인원**: 개인 프로젝트 (※ 팀 프로젝트였다면 수정)
- **역할**:
  - MCP 기반 통합 아키텍처 설계
...
> 📌 시스템 사진/구성도 이미지  
> - `../images/2025-xx-xx-llm-iot-agent/architecture.png`  
> - `../images/2025-xx-xx-llm-iot-agent/system_overview.png`
...
- (이미지) Cursor 차단 화면 / Windsurf 전환 화면  
  `../images/2025-xx-xx-llm-iot-agent/llm_client_switch.png`
